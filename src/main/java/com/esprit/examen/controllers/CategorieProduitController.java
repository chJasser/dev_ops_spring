...
public class CategorieProduitController {
	...
	@ResponseBody
	public CategorieProduit addCategorieProduit(@RequestBody CategorieProduit categoriepProduit) {
		
		return categorieProduitService.addCategorieProduit(categoriepProduit);
	}
	...
	@ResponseBody
	public CategorieProduit modifyCategorieProduit(@RequestBody CategorieProduit cetProduit) {
		return categorieProduitService.updateCategorieProduit(cetProduit);
	}
